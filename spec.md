...
- Chiều chất lượng + định nghĩa kiểm chứng được:
  ...
  - **Coverage:** bộ kiểm thử chính xử lý 22 câu grounded và 6 câu unsupported, gồm happy path, thiếu nguồn, số liệu, quy định và địa điểm; bộ mining mở rộng thêm 10 câu hỏi nguyên văn từ Discord, phủ đủ 4 lớp lỗi và đang được chạy đo riêng.
...
- Golden set (≥20 case theo cơ cấu trong guide §2.6, file trong eval/): `codebase/eval/handbook-golden.json` có **28 case**, gồm **22 grounded + 6 unsupported**; 22 grounded bao phủ lịch học, LMS, WiFi, thư viện, thẻ, chuyên cần, bảo lưu, điểm, trợ cấp, thiết bị, thực tập và địa điểm; 6 unsupported kiểm tra từ chối an toàn. Bộ mở rộng trực tiếp từ mining Discord nằm tại `codebase/eval/mining-golden.json`, gồm **10 case M01–M10**, mỗi case giữ `msg_id`, kênh, thời gian và câu hỏi nguyên văn, đồng thời được gắn một lớp lỗi ①–④. Bộ 10 case này bổ sung coverage cho điểm danh, level/lập team, lab, phòng học và tìm địa điểm; cần chạy đo riêng trước khi gộp tỷ lệ vào kết quả chính.
